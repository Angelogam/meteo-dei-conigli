        ...
        <div style={styles.left}>
          ...
          <div style={styles.list}>
            {launches.map((l) => (
              ...
              >
                <div style={{ fontWeight: "bold", color: "#fff", marginBottom: 2 }}>
                  {l.name}
                </div>
          ...
          {currentData && (
            <>
              <div style={styles.siteHeader}>
                <div>
                  ...
                  <span style={{ color: "#aaa" }}>
                    {site.exposure} &bull; {site.valley}
                  </span>
                </div>
                <div style={styles.weatherNow}>
                  ...
                  <span style={{ fontSize: "1.5rem", fontWeight: "bold" }}>
                    {Math.round(currentData.temperature)}&deg;C
                  </span>
                </div>
              </div>
                    ...
                    style={{
                      ...
                      background:
                        selectedDay === i
                          ...
                          : "rgba(255,255,255,0.05)",
                      borderColor:
                        selectedDay === i ? "#ff6b6b" : "rgba(255,255,255,0.1)",
                    }}
                  >
              ...
              <div style={styles.meteoGrid}>
                {[
                  {
                    label: "\u{1F321}\uFE0F Temperatura",
                    value: `${Math.round(currentData.temperature)}\u00B0C`,
                    sub: `Delta: ${thermalDelta}\u00B0C`,
                  },
                  {
                    label: "\u{1F4A7} Umidit\u00E0",
                    value: `${Math.round(currentData.humidity)}%`,
                    sub: `Rugiada: ${Math.round(currentData.dewPoint)}\u00B0C`,
                  },
                  {
                    label: "\u{2601}\uFE0F Nuvolosit\u00E0",
                    value: `${Math.round(currentData.cloudCover)}%`,
                    sub:
                      currentData.cloudCover < 30
                        ? "Cielo sereno \u{2600}\uFE0F"
                        : currentData.cloudCover < 60
                          ? "Nuvole moderate \u{26C5}"
                          : "Cielo coperto \u{2601}\uFE0F",
                  },
                  {
                    label: "\u{1F327}\uFE0F Precipitazioni",
                    value:
                      currentData.precipitation === 0
                        ? "Assenti \u2705"
                        : `${currentData.precipitation} mm/h \u26A0\uFE0F`,
                    sub:
                      currentData.precipitation === 0
                        ? "Ideale per volare"
                        : "Volo sconsigliato",
                  ...
                  {
                    label: "\u{1F441}\uFE0F Visibilit\u00E0",
                    value: `${Math.round(currentData.visibility)} km`,
                    sub:
                  ...
                  {
                    label: "\u{2600}\uFE0F UV",
                    value: `${Math.round(currentData.uvIndex)}`,
                    sub:
                      currentData.uvIndex < 3
                        ? "Basso"
                  ...
                  {[
                    {
                      ...
                      arrow: getWindArrow(currentData.windDir),
                    },
                    {
                      label: "80 m (quota termica)",
                      speed: currentData.wind80m,
                      dir: currentData.windDir80m,
                      arrow: currentData.wind80m
                        ? getWindArrow(currentData.windDir80m!)
                        : "\u2014",
                    },
                    {
                      label: "120 m (alta quota)",
                      speed: currentData.wind120m,
                      dir: currentData.windDir120m,
                      arrow: currentData.wind120m
                        ? getWindArrow(currentData.windDir120m!)
                        : "\u2014",
                    },
                  ].map((w, i) => (
                    <div key={i} style={styles.wCard}>
                      ...
                      <div style={{ fontSize: "1.1rem", fontWeight: "bold", color: "#fff" }}>
                        {w.speed != null
                          ? `${w.arrow} ${Math.round(w.speed)} km/h`
                          : "N/D"}
                      </div>
                      <div style={{ fontSize: "0.8rem", color: "#aaa" }}>
                        {w.dir != null ? getWindDirection(w.dir) : "\u2014"}
                        {i === 0 &&
                          isWindFavorable(w.dir as number, site.exposure) && (
                      ...
                      {i === 0 && (
                        <div style={{ fontSize: "0.65rem", color: "#ff6b6b" }}>
                          Raffiche: {Math.round(w.gust as number)} km/h
                        </div>
                      )}
                    </div>
                  ))}
                    ...
                    return (
                      <div key={h} style={styles.hwCard}>
                        ...
                        <div style={{ fontSize: "0.6rem", color: "#666" }}>
                          {getWindDirection(hd.windDir)}
                        </div>
                        <div style={{ fontSize: "0.6rem", color: "#ff6b6b" }}>
                          &#x26A1;{Math.round(hd.windGust)}
                        </div>
                      </div>
                    );
                  })}
              ...
              <div style={styles.twoCol}>
                <div style={styles.box}>
                  <h4 style={{ color: "#aaa", marginBottom: 5 }}>
                    &#x1F525; Forza termiche
                  </h4>
                  <div style={{ fontSize: "1.1rem", fontWeight: "bold", color: "#fff" }}>
                    {thermal?.level ?? "\u2014"}
              ...
              <div style={styles.twoCol}>
                <div style={styles.box}>
                  <h4 style={{ color: "#aaa", marginBottom: 5 }}>
                    &#x1F32A;\uFE0F Rischio turbolenze
                  </h4>
                  <div
                    style={{
                      fontSize: "1.1rem",
                      fontWeight: "bold",
                      color: turbulence?.color ?? "#fff",
                    }}
                  >
                    {turbulence?.level ?? "\u2014"}
                  </div>
                ...
                <div style={styles.box}>
                  ...
                  >
                    {getBaseReachable(currentData.temperature, thermalDelta)}
                  </div>
                  <div style={{ fontSize: "0.8rem", color: "#888" }}>
              ...
              <div style={{ ...styles.section, borderLeft: "3px solid #ffd93d" }}>
                <h3 style={{ color: "#ffd93d", marginBottom: 8 }}>
                  &#x1F4DD; Commento sulla giornata
                </h3>
                {summaries.map((s, i) => (
                  <div
                    key={i}
