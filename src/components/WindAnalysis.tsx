      ...
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(11, 1fr)", gap: 4, overflowX: "auto" }}>
          {hoursRange.map(hour => {
            ...
            return (
              <div key={hour} style={{ textAlign: "center", padding: 6, background: "rgba(255,Ora riscrivo `App.tsx` in modo pulito, importando i moduli appena creati:

<dyad-write path="src/App.tsx" description="Refactored App.tsx using modular components">
"use client";
