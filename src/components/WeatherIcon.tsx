...
function CloudSunIcon({ size, color }: { size: number; color: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function RainIcon({ size, color }: { size: number; color: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function DropletIcon({ size, color }: { size: number; color: string }) {
  return (
...
function ThermometerIcon({ size, color }: { size: number; color: string }) {
  return (
...
function FogIcon({ size, color }: { size: number; color: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function WeatherIcon({ type, size = 24, color = "#aaa" }: WeatherIconProps) {
  const iconMap: Record<string, React.ReactNode> = {
    ...
    cloud: <CloudIcon size={size} color={color} />,
    rain: <RainIcon size={size} color={color} />,
    snow: <SnowIcon size={size} color={color} />,
    thunder: <ThunderIcon size={size} color={color} />,
    fog: <FogIcon size={size} color={color} />,
    wind: <WindIcon size={size} color={color} />,
    droplet: <DropletIcon size={size} color={color} />,
    thermometer: <ThermometerIcon size={size} color={color} />,
    eye: <EyeIcon size={size} color={color} />,
    flame: <FlameIcon size={size} color={color} />,
    plane: <PlaneIcon size={size} color={color} />,
    mountain: <MountainIcon size={size} color={color} />,
    star: <StarIcon size={size} color={color} />,
    moon: <MoonIcon size={size} color={color} />,
    clock: <ClockIcon size={size} color={color} />,
  };

  return <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center" }}>{iconMap[type] || null}</span>;
}
